...
возникающие внутри блока with. Если выкидывается неожидаемый тип исключения, 
...
- Чтобы определить, является ли вызванное исключение дочерним по отношению к переданным 
классам ошибок, воспользуйтесь функцией `issubclass`. Вторым аргументом она может 
принимать кортеж классов.
