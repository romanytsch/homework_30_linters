...
### Что нужно сделать
Добавьте в приложение выше(hw1_add_logging) скопировав его в текущею папку, функцию, 
которая будет конфигурировать логирование с помощью `basicConfig`. 
Обработчик должен выводить логи в стандартный поток вывода (stdout). 
